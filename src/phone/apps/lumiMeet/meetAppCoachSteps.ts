...
export const MEET_APP_COACH_STEPS: MeetAppCoachStep[] = [
  ...
  },
  {
    ...
    archiveTab: 'progress',
    title: '邂逅残卷 / 总结进度',
    body: '高亮为档案分页。点「总结进度」可查看各匹配角色：与微信私聊[[共用]]记忆间隔（每 N 轮 NPC 文字回复计 1 轮），满轮后合并写入 `[遇见]` 长期记忆；成功时会有居中「记忆总结成功」提示。',
  },
  {
    ...
    archiveTab: 'progress',
    title: '总结进度怎么看',
    body: '每位角色一张进度卡：金色条为距上次总结已积累的 NPC 回复轮数；文案会写「还需 X 轮」或「下轮可触发」。计数按你在「联络绑定」选的[[微信账号 + 玩家身份]]对齐，不会混入其它马甲。若全局关闭自动总结，此处会提示先去微信记忆引擎开启。',
  },
  {
    target: 'nav-discover',
    tab: 'discover',
